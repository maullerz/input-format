...
function _default(template) {
  let placeholder = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'x';
  let should_close_braces = arguments.length > 2 ? arguments[2] : undefined;
  ...
  const characters_in_template = (0, _helpers.count_occurences)(placeholder, template);
  return function (value) {
    ...
    let filled_in_template = ''; // Using `.split('')` here instead of normal `for ... of`
